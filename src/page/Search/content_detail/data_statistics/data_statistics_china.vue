        ...
        >
          ...
          >
            <div class="detail-box-top">
              <div v-if="this.dataLen.area!==null">
                <div
                  id="myMap"
                  ref="myMap"
              ...
              <div
                v-if="this.dataLen.area===null"
                style="width: 900px;height:500px;border:1px solid #eee;font-size:30px;text-align:center;line-height:500px;"
              >暂无相关数据</div>
            </div>
          </el-tab-pane>
          <el-tab-pane
          ...
          >
            <div class="detail-box-top">
              ...
              <div
                v-if="this.dataLen.ageGroup!==null"
                id="ageGroupbox"
                style="width: 900px; height: 500px;"
              ></div>
              <div
          ...
          >
            <div class="detail-box-top">
              ...
              <div
                v-if="this.dataLen.sampleType!==null"
                id="sampleTypebox"
                style="width: 900px; height: 500px;"
              ></div>
              <div
...
export default {
  ...
  data() {
    return {
      ...
      sexTData: [], // 性别表格
      ageTGroupData: [], // 年龄段表格
      sampleTypeTData: [], // 样本类型表格
      yearTData: [], // 年份表格
      activeName1: 'first', // echarts图表默认展示页面标记
      activeName2: 'first', // 表格默认展示页面标记
      from: '', // 数据来源
      tabCur: '1', // 标记选择的是echarts还是表格tab
      queryObj: {}, // 获取url地址信息
  ...
  methods: {
    ...
    joinData(arr, str) {
      ...
      for (let i = 0; i < copyArr.length; i++) {
        ...
        if (filterD < 0) {
          // 小于0 说明filter为-1，等价于该元素不在newArr数组中
          // 不在就把他新添加到newArr数组中
          newArr.push(copyArr[i])
        } else {
          // 否则 说明filter不为-1，等价于该元素存在newArr数组中
          // 就把他累加到newArr数组已有的数据中
